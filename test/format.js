...
describe('format', () => {
  ...
  it('should throw a type error when not provided a string as first argument', () => {
    assert.throws(function() { format(1, date) },
      '‘format’ expected a value of type String as its first argument; ' +
      'received 1');
  });

  it('should throw a type error when provided an invalid date as second argument', () => {
    assert.throws(function() { format('YYYY', new Date('2015-33-33')) },
      '‘format’ expected a value of type ValidDate as its second argument; ' +
